...
> {
>   "registry-mirrors": ["这边替换成自己的实际地址","https://registry.aliyuncs.com","https://registry.docker-cn.com"]
> }
> EOF
...
```
安装错误，需要安装kubenetes-cni,可以按照如下操作安装：
```
...
kubeadm join 10.206.0.8:6443 --token iupcp9.f0f539bsgjg88ofz \
    --discovery-token-ca-cert-hash sha256:514b51daf5c9c2f55ebad13ccf49e6e2c60c2f1a0ff77b10bf9862af2c0b7f6f
```
> (3)根据日志提示
