...
![image-20220306202426968](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306202426968.png)

![image-20220306202443160](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306202443160.png)
...
![image-20220306202607514](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306202607514.png)
...
![image-20220306202620777](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306202620777.png)
...
![image-20220306202930647](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306202930647.png)
...
![image-20220306203123733](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306203123733.png)
...
![image-20220306203154748](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306203154748.png)
...
![image-20220306203803612](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306203803612.png)
...
![image-20220306204312454](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306204312454.png)
...
![image-20220306204506558](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306204506558.png)
...
![image-20220306204741233](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306204741233.png)

2、模拟数据丢失

![image-20220306204805913](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306204805913.png)

3、通过备份文件恢复数据

![image-20220306205038154](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205038154.png)

![image-20220306205048119](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205048119.png)
...
![image-20220306205256896](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205256896.png)

**问题：数据都是实时持久化到磁盘吗？**

由于操作系统的缓存机制，AOF 数据并没有真正地写入硬盘，而是进入了系统的硬盘缓存。什么时候把缓冲区的内容写入到 AOF 文件？

![image-20220306205354390](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205354390.png)
...
![image-20220306205534631](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205534631.png)

**问题：重写过程中，AOF 文件被更改了怎么办？**

![image-20220306205612338](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205612338.png)

![image-20220306205623122](https://gitee.com/forge-logic/images-lib/raw/master/img/image-20220306205623122.png)
